...
public final class RenderUtil
{
    ...
    {
        /*
         * final HudModule l_Hud = (HudModule) Summit.INSTANCE.getModuleManager().find(HudModule.class);
         * 
         ...
         * GL11.glHint(GL11.GL_POINT_SMOOTH_HINT, GL11.GL_NICEST); GL11.glDepthMask(false); Summit.INSTANCE.customFont.drawSplitString(p_Name, p_X, p_Y, p_K, p_Color);
    ...
    public static FontRenderer GetFontRenderer()
    {
        ...
        return Wrapper.GetMC().fontRenderer;//Summit.GetFontManager().GetFontRenderer();
    }

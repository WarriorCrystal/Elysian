...
import com.elysian.client.mixin.mixins.IEntityLivingBase;
import com.elysian.client.module.modules.combat.AutoDemon;
import com.elysian.client.turok.TurokMath;
...
public class EntityUtil {
    ...
    public static Color getColor(Entity entity, int red, int green, int blue, int alpha, boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer) {
            if (colorFriends && FriendUtil.isFriend(entity.getName())) {
                ...
                if (AutoDemon.get_target() != null) {
                    if (AutoDemon.get_target().equals(entity)) {
    ...
    public static void attackEntity(final Entity entity, final boolean packet, final Settings.Setting setting) {
        if (packet) {
            mc.player.connection.sendPacket(new CPacketUseEntity(entity));
        } else {
            mc.playerController.attackEntity(mc.player, entity);

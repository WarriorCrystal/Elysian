...
public class BlockUtil {
    ...
    public static boolean placeBlock(BlockPos pos, int hand, boolean rotate, boolean packet, EnumProperty<AutoDemon.Swing> isSneaking) {
    ...
    public static void placeBlockIntercepted(BlockPos pos, int slot, boolean rotate, boolean rotateBack, Settings.Setting setting) {
        int old_slot = -1;
        if (slot != mc.player.inventory.currentItem) {
            old_slot = mc.player.inventory.currentItem;
            mc.player.inventory.currentItem = slot;

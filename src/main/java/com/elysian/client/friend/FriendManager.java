    ...
    public FriendManager() {
        ...
        new Config("friends.json"){
            ...
            public void load(Object... source) {
                ...
                friends.forEach(node -> {
                    ...
                    try {
                        ...
                        Elysian.getInstance().getFriendManager().getRegistry().add(new Friend(friendNode.get("friend-label").getAsString(), friendNode.get("friend-alias").getAsString()));
                    }
                    catch (Throwable e) {
                        e.printStackTrace();
                    }
            ...
            public void save(Object... destination) {
                ...
                if (Elysian.getInstance().getFriendManager().getRegistry().isEmpty()) {
                    return;
                }
                JsonArray friends = new JsonArray();
                Elysian.getInstance().getFriendManager().getRegistry().forEach(friend -> {
                    try {

...
import com.elysian.client.command.CommandGS;
...
@CommandGS.Declaration(name = "AutoGear", syntax = "gear set/save/del/list [name]", alias = {"gear", "gr", "kit"})
public class AutoGearCommand extends CommandGS {

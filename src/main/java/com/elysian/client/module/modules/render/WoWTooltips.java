...
import com.elysian.client.util.summit.RenderUtil;

import me.zero.alpine.fork.listener.EventHandler;
import me.zero.alpine.fork.listener.Listener;

public class WoWTooltips extends ToggleableModule {

    public WoWTooltips() {
        super("WoWTooltips", new String[] {"Tooltips"}, "Displays tooltips like in world of warcraft", ModuleType.RENDER);

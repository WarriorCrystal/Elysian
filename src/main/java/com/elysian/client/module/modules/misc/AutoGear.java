...
import com.elysian.client.command.commands.AutoGearCommand;
...
public class AutoGear extends ToggleableModule {
    ...
    public AutoGear() {
        super("AutoGear", new String[] {"AutoGear"}, "AutoGear", ModuleType.MISC);
        this.offerProperties(tickDelay, switchForTick, enderChest, confirmSort, invasive, confirmSort, closeAfter, infoMsgs, debugMode,  this.keybind);
    }
    private final NumberProperty<Integer> tickDelay= new NumberProperty<Integer>(0, 0, 20, "tickDelay");
    private final NumberProperty<Integer> switchForTick = new NumberProperty<Integer>(1, 1, 100, "switchForTick");
    private final Property<Boolean> enderChest = new Property<Boolean>(false, "EnderChest", "");
    ...
    private final Property<Boolean> infoMsgs = new Property<Boolean>(true, "Info Msgs", "");
    private final Property<Boolean> debugMode = new Property<Boolean>(false, "Debug Mode", "");
